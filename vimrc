...
func SetTitle()
	...
	if expand("%:e") == 'c'
		...
		call append(line(".")+2,"#include<ctype.h>")
...
"新建文件后自动定位到文件末尾
"将.cpp文件定位到第四行
autocmd BufNewFile *.c normal 7G
autocmd BufNewFile *.cpp normal 17G
autocmd BufNewFile *.{java,php} normal 3G
autocmd BufNewFile *.{py,h,mkd,md} normal G
autocmd BufNewFile *.html normal 8G
autocmd BufNewFile *.css normal 2G
"添加代码关键字词典
au FileType php setlocal dict+=/usr/share/vim/vim74/dict/php_funclist.dict
au FileType css setlocal dict+=/usr/share/vim/vim74/dict/css.dict
au FileType c setlocal dict+=/usr/share/vim/vim74/dict/c.dict
au FileType cpp setlocal dict+=/usr/share/vim/vim74/dict/cpp.dict
au FileType scale setlocal dict+=/usr/share/vim/vim74/dict/scale.dict
au FileType javascript setlocal dict+=/usr/share/vim/vim74/dict/javascript.dict
au FileType html setlocal dict+=/usr/share/vim/vim74/dict/javascript.dict
au FileType html setlocal dict+=/usr/share/vim/vim74/dict/css.dict
au FileType html setlocal dict+=/usr/share/vim/vim74/dict/html.dict
...
let g:ycm_filetype_blacklist={ 'html':1,'md':1,'mkd':1,"txt":1}
